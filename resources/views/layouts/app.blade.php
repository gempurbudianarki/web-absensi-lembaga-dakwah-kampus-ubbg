...
<head>
    ...
    <title>{{ config('app.name', 'LDK Absensi') }}</title>
...
<body>
    ...
    <!-- Scripts (INI BAGIAN PENTING YANG MEMPERBAIKI TOMBOL) -->
    ...
    {{-- Ini akan memuat script custom dari setiap halaman --}}
    @stack('scripts') 
</body>
</html>
